        ...
        this.innerHTML = `
            ...
            <ul class="sidebar__lista">
                ...
                <li class="sidebar__elemento sidebar__elemento--borde">
                    <a class="sidebar__enlace" href="unit-1.html">Unit 1. Grammar and Use of English</a>
                ...
                <li class="sidebar__elemento sidebar__elemento--borde">
                    <a class="sidebar__enlace" href="unit-2.html">Unit 2. Reading and Writing</a>
                    <ul class="sidebar__lista ps-4">
                ...
                <li class="sidebar__elemento sidebar__elemento--borde">
                    <a class="sidebar__enlace" href="unit-3.html">Unit 3. Speaking and Listening</a>
                    <ul class="sidebar__lista ps-4">
                        <li class="sidebar__elemento">
                ...
                <li class="sidebar__elemento sidebar__elemento--borde">
                    <a class="sidebar__enlace" href="unit-4.html">Unit 4. Getting to know additional C1 exams</a>
                    <ul class="sidebar__lista ps-4">
